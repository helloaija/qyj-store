 ...
 */
@Controller
@RequestMapping("/admin/app/stockOrder")
public class AppStockOrderController extends BaseController {

    private static final Logger logger = LoggerFactory.getLogger(AppStockOrderController.class);
